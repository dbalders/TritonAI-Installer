...
interface WindowsAppSearchOptions {
...
function findWindowsT3CodeApp(homeDir = os.homedir(), options: WindowsAppSearchOptions = {}) {
...
async function waitForWindowsT3CodeApp(homeDir, options: WindowsAppSearchOptions = {}) {
