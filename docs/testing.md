...
- Regressions where stable plugin packaging drifts from the reviewed catalog's source, package set, package, manifest, or SDK artifact descriptor digests; accepts policy-looking fields that are not enforced; or accepts a noncanonical origin, moving or mismatched ref/commit, implicit dirty checkout, ambiguous package selection, source/tests, symlinks, special files, unsafe paths, or manifest/package/file drift.
