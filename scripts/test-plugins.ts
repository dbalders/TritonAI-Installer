...
function assertLatestStableReleaseSelection() {
  ...
  assert.deepStrictEqual(automatic.selectedIds, ["github", "google-workspace", "microsoft-365", "n8n"]);
  ...
  assert.deepStrictEqual(production.selectedIds, ["github", "google-workspace", "microsoft-365", "n8n"]);
  assert.throws(
